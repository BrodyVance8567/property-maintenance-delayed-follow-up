...
> Design notes for **property-maintenance-delayed-follow-up** — a runnable typescript example that Schedule a property-management maintenance follow-up after a domain-shaped delay in TypeScript.
...
- **Feature code** — the actual task: property-maintenance-follow-up.
